                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-8 max-w-4xl">
                    ...
                    {showPriceCalculation && (
                        <>
                            <p >
                                ...
                                <br />
                                <span className="font-bold ml-2">{totalCost}€</span> {rabatt > 0 ? `- ${rabatt}€ Rabatt` : ''} = <span className="font-bold ml-2">{totalCost - rabatt}€</span>
                            </p>
                    ...
                    {submitStatus === "success" && (
                        <div className="border-foreground border rounded-full px-6 py-4 bg-background text-foreground">
                            <p className="text-xl">Bewerbung erfolgreich eingereicht!</p>
                        </div>
                    )}
                    {submitStatus === "error" && (
                        <div className="border-foreground border rounded-full px-6 py-4 bg-background text-foreground">
